...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_endpoints = settings.get('SCRAPEOPS_FAKE_USER_ENDPOINT', 'https://headers.scrapeops.io/v1/browser-headers')
        self.scrapeops_fake_user_service_agent_active = settings.get('SCRAPEOPS_FAKE_USER_SERVICE_AGENT_ENABLED', False)
    ...
    def _scrapeops_fake_user_agents_enabled(self):
        if self.scrapeops_api_key is None or self.scrapeops_api_key == '':
            self.scrapeops_fake_user_service_agent_active = False
        else:
            self.scrapeops_fake_user_service_agent_active = True
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def __init__(self, settings):
        self.scrapeops_api_key = settings.get('SCRAPEOPS_API_KEY')
        self.scrapeops_endpoints = settings.get('SCRAPEOPS_FAKE_BROWSER_HEADER_ENDPOINT', 'https://headers.scrapeops.io/v1/browser-headers')
